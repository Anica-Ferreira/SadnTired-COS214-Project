...
void testStaffOperations(NurserySystemFacade& nursery) {
    ...
    // View staff members
    cout << "\n1. Viewing staff members:" << endl;
    cout << nursery.viewStaffMembers() << endl;

    // View pending tasks
    cout << "\n2. Viewing pending tasks:" << endl;
    cout << nursery.viewPendingTasks() << endl;
    ...
    // Complete task
    cout << "\n4. Completing task:" << endl;
    cout << nursery.completeTask(1) << endl;
}
...
void testBundlesAndSpecialFeatures(NurserySystemFacade& nursery) {
    ...
    cout << "\n1. Viewing available bundles:" << endl;
    cout << nursery.viewAvailableBundles() << endl;
