...
std::string PlantedState::getStateName() const
{
    return "Planted";
}
...
std::string WateredState::getStateName() const
{
    return "Watered";
}
...
std::string DryState::getStateName() const
{
    return "Dry";
}
...
std::string ReadyForSaleState::getStateName() const
{
